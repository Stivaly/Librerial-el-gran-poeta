...
<script setup>
  ...
  const handleSubmit = async () => {
    ...
    if (!lnombre.value || !leditorial.value || !lpaginas.value || !lfecha.value || !lidioma.value || !lautor.value || !lresumen.value) {
    ...
    const nuevoLibro = {
      ...
      libro_ISBN: "", // Falta en el formulario
      id_editorial: leditorial.value,  
      id_autor: lautor.value,  
      id_idioma: lidioma.value,  
      id_genero: 0  // falta en el formulario
    };
